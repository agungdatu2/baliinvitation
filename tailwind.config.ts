  ...
  theme: {
    extend: {
      ...
      animation: {
        ...
        // Durasi panjang + linear supaya kecepatannya konstan & pelan ("elegant"),
        // bukan ngebut lalu nyentak balik ke awal.
        "groove-marquee": "groove-marquee 100s linear infinite",
      },
    },
  },
  plugins: [],
