...
export const LUME_DICT = {
  id: {
    ...
    // Pixel theme (tema "Pixel" 8-bit/retro game) — istilah game universal
    // (PRESS START, GAME OVER, dst.) sengaja tetap Inggris di kedua bahasa
    // karena itu memang konvensi genre, bukan teks yang perlu diterjemahkan.
    pixelInsertCoin: "INSERT COIN",
    pixelPressStart: "PRESS START",
    pixelPlayer1: "PLAYER 1",
    pixelPlayer2: "PLAYER 2",
    pixelQuestLog: "QUEST LOG",
    pixelLevelSelect: "LEVEL SELECT",
    pixelSpectatorMode: "SPECTATOR MODE",
    pixelCharacterSelect: "CHARACTER SELECT",
    pixelQuestRsvp: "QUEST: CONFIRM ATTENDANCE",
    pixelScreenshots: "SCREENSHOTS",
    pixelBonusLevel: "BONUS LEVEL: GIFT",
    pixelGameOver: "GAME OVER",
    pixelThanksForPlaying: "Terima kasih sudah memainkan kisah kami",
    pixelPauseMenu: "PAUSE MENU",
    pixelSfxOn: "SFX: ON",
    pixelSfxOff: "SFX: OFF",
    pixelBgmOn: "BGM: ON",
    pixelBgmOff: "BGM: OFF",
    pixelAchievementUnlocked: "ACHIEVEMENT UNLOCKED",
    pixelRsvpConfirmed: "RSVP Terkonfirmasi!",
    pixelLevelComplete: "LEVEL COMPLETE",
    pixelSelectCharacter: "SELECT YOUR CHARACTER",
    pixelMale: "MALE",
    pixelFemale: "FEMALE",
    pixelQuickInfo: "QUICK INFO",
    pixelTapToOpen: "Tap untuk buka",
    pixelWalkHint: "Tahan tombol kiri/kanan untuk jalan",
    pixelContinueGame: "CONTINUE",
    pixelCreatedBy: "Created By",
  },
  en: {
    dateLocale: "en-US",
    ...
    pixelBonusLevel: "BONUS LEVEL: GIFT",
    pixelGameOver: "GAME OVER",
    pixelThanksForPlaying: "Thank you for playing our story",
    pixelPauseMenu: "PAUSE MENU",
    pixelSfxOn: "SFX: ON",
    pixelSfxOff: "SFX: OFF",
    pixelBgmOn: "BGM: ON",
    pixelBgmOff: "BGM: OFF",
    pixelAchievementUnlocked: "ACHIEVEMENT UNLOCKED",
    pixelRsvpConfirmed: "RSVP Confirmed!",
    pixelLevelComplete: "LEVEL COMPLETE",
    pixelSelectCharacter: "SELECT YOUR CHARACTER",
    pixelMale: "MALE",
    pixelFemale: "FEMALE",
    pixelQuickInfo: "QUICK INFO",
    pixelTapToOpen: "Tap to open",
    pixelWalkHint: "Hold left/right to walk",
    pixelContinueGame: "CONTINUE",
    pixelCreatedBy: "Created By",
  },
