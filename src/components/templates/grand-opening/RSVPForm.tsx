  ...
  return (
    <section className="groove-overlay-dark text-groove-bg py-16 px-6">
      <div className="max-w-5xl mx-auto">
        <div className="grid md:grid-cols-2 gap-10 md:gap-16 mb-14">
          ...
          {sent ? (
            ...
            <form onSubmit={submit} className="space-y-5 text-left">
              ...
              <button
                disabled={loading}
                className="px-8 py-2.5 text-groove-ink text-xs font-semibold tracking-widest uppercase disabled:opacity-50 rounded-full"
                style={{ backgroundImage: "linear-gradient(135deg, #e8cd8a 0%, #c9a45c 45%, #8a6d2f 100%)" }}
              >
        ...
        {wishes.length > 0 && (
          <>
            <h3 className="font-groove-display text-xl text-groove-bg mb-5" style={{ fontWeight: 500 }}>
              {t.guestBookHeading}
            </h3>
