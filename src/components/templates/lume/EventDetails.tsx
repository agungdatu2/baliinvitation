    ...
    <section className="groove-overlay text-groove-bg py-16 px-6">
      <div className="max-w-2xl mx-auto">
        <div className="text-center mb-8">
          <p className="font-groove-label uppercase tracking-widest text-xs text-groove-bg/70 mb-2">Rangkaian Acara</p>
        ...
        <div className="grid gap-5 md:grid-cols-2">
          {events.map((ev, i) => (
            <div key={i} className="border border-groove-line rounded-lg p-6 flex flex-col items-center text-center">
              <PartyPopper className="h-9 w-9 text-groove-bg/70 mb-3" strokeWidth={1.5} />
