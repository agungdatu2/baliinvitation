...
function ProfileCard({
  ...
  return (
    <div className="text-center group">
      ...
      <p className="font-groove-body text-sm text-groove-ink/70">{parents}</p>
      {instagram && (
        <a
          href={`https://instagram.com/${instagram.replace("@", "")}`}
          target="_blank"
          className="font-groove-label inline-flex items-center gap-1.5 text-xs text-groove-secondary mt-3"
        >
