...
// Section "Doa" full-viewport (100lvh) dengan foto background sendiri (bukan
...
// (`fixed inset-0 -z-10` di level <main>, lihat MuseTemplate) — foto & overlay
  ...
  return (
    <section className="relative z-10 h-[100lvh] overflow-hidden flex items-end text-groove-bg">
      ...
      {/* t.prayerLabel ("Doa"/"Prayer") sengaja TIDAK ditampilkan di sini — cuma
          ...
          di undangan publik. */}
      <div className="relative px-6 md:px-14 pb-24 md:pb-28 max-w-xl">
