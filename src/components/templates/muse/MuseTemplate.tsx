...
// Orchestrator utama tema "Muse" — diturunkan (duplikat) dari "Reverie", sama
// persis layout split sticky+scroll-nya, tapi TANPA scroll-snap (lihat catatan
// di bawah); scroll bebas/normal seperti tema Lume. Semua data & gambar 100%
// dinamis dari `data` (hasil input Form Admin), bukan hardcode.
export default function MuseTemplate({ data, guestName, guestId }: TemplateProps) {
  ...
  // Sengaja TIDAK toggle scroll-snap class ke <html> (beda dari ReverieTemplate)
  // — tema Muse pakai scroll bebas biasa, section-section dipisahkan cukup lewat
  // tinggi 100lvh masing-masing tanpa dipaksa snap per-section.
