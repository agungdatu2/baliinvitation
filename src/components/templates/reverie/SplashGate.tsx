...
// Tahap 1: LoadingScreen (fullscreen takeover, indikator "Loading NN%" minimal
// ala cc-balky.webflow.io) — dilewati kalau showIntro=false (paket tidak
// termasuk fitur intro).
...
// (lihat FixedVideoBackground/ReverieTemplate).
