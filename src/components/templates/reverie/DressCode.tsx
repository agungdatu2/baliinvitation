  ...
  return (
    <section className="groove-overlay-dark text-groove-bg py-16 px-6">
      <div className="max-w-5xl mx-auto">
        <h3 className="font-groove-display uppercase text-4xl mb-3" style={{ fontWeight: 500 }}>
          {t.dresscode}
        </h3>
        <p className="font-groove-body text-sm text-groove-bg/80 mb-8">{t.dresscodeNote}</p>
